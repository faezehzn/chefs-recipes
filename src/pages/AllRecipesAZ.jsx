...
import AllRecipesAZMain from "../components/AllRecipesAZMain";


const AllRecipesAZ = () => {
  return (
    <Wrapper>
      <Container fluid className="all-recipes-az">
        <Row>
          <Col md={12}>
            <NavBar navItems={navItems} />
              <BaseHeader customHeaderName={'All Recipes A-Z'} />
              <AllRecipesAZMain />
              <SearchContainer />
            <Footer />
            <WinkerUpBtn />
